...
def pull(self, platform):
    ...
    for pic_name in pics:
        ...
        connect = subprocess.Popen('adb pull /sdcard/zhubo/' + platform + '/' + pic_name  + ' /Users/wubin/Desktop/zhubo/'+platform + '/' + pic_name,
                                    stderr=subprocess.PIPE, stdout=subprocess.PIPE, shell=True)
    print('手机中的图像成功发送到电脑')
```
...
![](http://www.justdopython.com/assets/images/2020/06/zhubo/yz_-1.png)
