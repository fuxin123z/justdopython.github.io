...
![显示结果](../assets/images/2019/python/python_web_template_01.jpg)
...
很多时候，需要更智能的模板渲染，即能给渲染编程，比如男生一个样式，女生一样样式，控制结构指令需要用`{% command %}` 标记来指定，下面介绍下一些简单的控制结构
...
![显示结果](../assets/images/2019/python/python_web_template_02.jpg)
