...
layout: post
category: python
title: 如果用 Python 在京东上抢口罩
tagline: by 極光
tags:
  - python100
---

全国抗"疫"这么久终于见到曙光，在家待了一个月，现在终于就要复工了，可是却发现出门必备的口罩却一直买不到。最近看到京东上每天都会有口罩的秒杀活动，试了两次却怎么也抢不到，到了抢购的时间，浏览器的页面根本就刷新不出来，等刷出来秒杀也结束了。现在每天只放出一万个，却有几百万人在抢，很想知道别人是怎么抢到的，于是就在网上找了大神公开出来的抢购代码。看了下代码并不复杂，现在我们就报着学习的态度一起看看。
